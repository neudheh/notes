## Scarcity
- ==Scarcity arises because resources are limited nut human wants are unlimited==
- This is because the resources available for production of goods and services are insufficient to satisfy all human wants
- A resources is scarce if the demand at a rice of zero, exceeds the available supply
- Practically all resources are scarce
## Factors of production
- The resources used to produce goods and services are called factors of productions
### Land
- Land refers to all natural resources used or are available for production of goods and services
- Land for factories, natural resources (water, wood, metals, fossil fuels ores)
- Renewable natural resources renew themselves at a fast enough pace for substantial economic extraction (water, wind)
- Non-renewable natural resources do not (fossil fuels, mineral deposits, soil)
- The amount of natural resources that a country can have is constrained by its geographical size and ability to access it
- Land is exchanged for rent
### Labour 
- Labour refers to the physical and mental effort of people used ore are available for production of goods or services
...
- Fixed capital is durable and is used time and time again in the production process ( factory buildings, stadium, school building, machinery, equipment)
- Circulating capital (inventory) refers to items such as raw materials, semi-finished goods, and stocks of finished goods waiting to be sold
...
- Stocks, bounds, money are  used to purchase capital but is not itself capital as it does not produce anything
- Capital is exchanged for rent
### Entrepreneur
...
- Entrepreneurs organises production, by combining other factors of production to produce a good or service
- Entrepreneurs innovate, developing new production and methods of production
- The take overall responsibility for the decision making process in the firm, deciding what to produce and how much, how to market the product, etc
...
- Consumers have limited income and have to decide on what to buy since they can buy everything they want
- Firms can afford to only pay for a limited amount of resources and have to decide what to produce and what resources to hire
...
- Each time a scarce resources is used to satisfy a want, an alternative want is sacrificed
- Opportunity cost is the cost of using resources for a certain activity
- ==Opportunity cost is the net benefit that could be derived from the next best alternative forgone==
- It includes any money not spend on the current options as it is the net benefit
>[!NOTE] Example
...
![[decision making.jpg]]
- There are 3 economic agents, consumers, producers and governments
- They must interact with each other at the national and international levels
- Due to the fundamental problem of scarcity, all three key economic agents have to make decisions (choices)
- They have to take into account various **considerations**, recognise their **constraints** they are operating within, and consider the **costs** and **benefits**, as wells as **information** and **perspectives** to weigh the costs and benefits
- The decision can have both intended and unintended consequences
- When changes in the environment occur economic agents may have to go through the decision making process again
- Decisions made by economic agents are in fact decisions on how to allocate resources
### Objectives of each agents
- The choices made by consumers, producers are based on their goals
- Economists assume that rational economic agents aim to maximise their self-interests
...
$$Profits = Total\ revenue\ from\ selling\ good/service\ -Total\ cost\ of\ producing\ the\ good/service$$
- In an economy, governments aim to maximise social welfare when making policy decisions
...
- Economic agents will then decide on the best-ranked choice that enables them to maximise their self-interest
...
- Governments also face the the constraint of the social and political acceptibility of their chosen mode of intervention
...
- ==It involves marginal costs and benefit to decide if they should continue or stop the current or existing activity==
...
- The marginalist principle states that if the marginal benefit is greater than the marginal cost, it is rational to do more of an activity since the addition to total benefit exceeds the addition to total cost, meaning that net total benefit is rising
...
### Information
- In order to make sound decisions, economic agents first have to gather accurate information both quantitative and qualitative on the costs and benefits of every available choice
- Consumers buying decisions are aimed at maximising net total utility, and will consider information that will help them to weigh private benefit and costs of different goods/ services
- E.g. Benefits from different goods/ services that accrue to the buy of the good -> features of different goods/ services, prices of different goods and services
- Firms production and selling decisions are aimed at maximising total profits, and will obtain information that aids them to weight private benefit and costs
- Market research to find out the tastes of consumers, the costs of inputs, whether purchase or provided by the entrepreneur, to produce the goods/ services
...
- Decisions made with the expectation that the decision will achieve its intended outcome and resolve the economic problem
...
- Decisions made by economic agents can have multifaceted implications
- The decisions made by consumers of firms may not just impact the decision maker, but other economic agents too
- The decisions made by economic agents at the national level can have an impact at the international level
## Production-possibilities curve
- ==A production possibilities curve shows the **combinations of the maximum amount of two goods** that an economy can produce **within a certain period**, usually a year, with a **fixed level of technology,** and when **all available resources are fully and efficiently employed**==
### Assumptions
- A specific period
- State of technology remains unchanged
- Total available resources remains the same
...
#### Choice
- The economy must decided which attainable combination to produces
- In doing so, it decides what to produce and how much to produce
- The chose output combination is dependent on societies preferences
#### Trade-offs and opportunity cost
- The downward sloping nature of the PPC illustrates that when a country produces more units of one type of good, it has to sacrifice some units of the other good
...
- Assuming there are only 2 alternative uses of the resources, producing more consumer goods will incur a opportunity cost of the net benefit foregone from the next best alternatives, which is producing more capital goods
- Resources are also not equally suited for producing differing goods, leading to an increasing opportunity cost
...
- It must sacrifice on good to obtain more units of another, and is in a state of productive efficiency
- In contrast, if a country is producing inside the ppc, there is a wastage of resources and the country is in s state of productive inefficiency due to underemployment or unemployment
...
- Unemployment is when when there is failure to use all resources (some resoruces are not used at all for production)
### Shifting
...
- The productivity of a factor input is the output per unit per factor input
...
- The more investment a country undertakes, the more capital goods it producers, the greater the productive capacity of the country in the following time period, as capital goods are used to produce other goods
- If a country chooses to produce more capital goods rather than consumer goods, it will be able to produce more capital and consumer goods in the future, reflected by an outward shift in the PPC in the future
...
- ==Capital consumption refers to the reduction in value of capital goods over a on-year period due to physical wear and tear, and also due to capital becoming obsolete==
...
### Efficiency
- ==Productive efficiency is when the economy could no produce any more of one good without sacrificing production of another good==
...
- The economy has to be already producing on the PPC, at the point on the PPC which maximises society's welfare in accordance with society's preferences\
...
### Equity
- Another criterion for assessing best use of resources is equity in distribution of output
- Equity is achieved when output is distributed in a way that is fair or just
- What considered fair is based on society's values judgement
- The current output may be deemed allocative efficient, but could be inequitable or unfair is some people are extremely rich, while others are extremely poor
- How decide what society wants is through those who are willing and can pay for what they want (i.e. the rich)
- Income equality, which leads to inequitable output distribution, cannot be neglected
