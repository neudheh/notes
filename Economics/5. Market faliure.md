...
#### Moral hazard
- Moral hazard is the situation in which economic agents take greater risks/ act less carefully than they normally would because the resulting costs would not be borne by them
- Moral hazard happens after the transaction has completed

- Moral hazard arises when a party to a contract changes their behaviour as a consequence of the contract

>[!EXAMPLE]
>- Insurance may cause people to take greater risks because they know part of the costs of undesirable outcomes will be borne by the insurance companies
>- A person who buys home insurance for theft may become very casual about locking the doors of their house
>- This changes the risk the insurance company thought they were taking on based on the person's history of no burglary

- When the insured party takes unobserved action (not observed by the insurer i.e. no information), that increases the probability of the event that triggers payment from the insurer
- This can drive up the insurer's cost to the point that the business is no longer profitable
- The service will no longer be provided since there is insufficient incentives (profits) to offer it for sale, and there will be a missing market for the service

- It can also arise in a principal-agent problem, where one person (agent) is performing some tasks on behalf of another (principal)
- If the action of the agent cannot be perfect monitored, the agent would undertake more risk or put in less effort than what is desired
- E.g. the worker being an agent of the employer might shirk his responsibilities if the boss is not looking, resulting ins less than desirable results

- Moral hazard creates a lack of traust between two potential buyers and sellers
- This means that mutually advantageous trade might not take place, and there is thus no market for it
- Hence, there is market failure as the potential net benefit to society from having these goods and services traded is lost, and society's welfare is not maximised

#### Supplier-induced demand
- If a producer has more information than the consumer, a situation of supplier induced demand may arise where consumers end up buying more goods/ services than what is optimal for them
- P: Point out the sources of market failure
	- A doctor may know more about the health of a patient and the relevance of treatments of health checks than the patient does
	...
	- This causes the patients perceived MPB to be higher than the true MPB
	- Assuming no externalities, the MSB curve is the same as the True MPB curve, and the MSC curve is the same as the MPC curve, which is also the supply curve
- S: Social equilibrium/ Market equilibrium
	- Left to market forces, the market equilibrium output will be at $Q$, where DD = SS
	- The socially optimal output will be at $Q*$, where MSB = MSC, and society's welfare is maximised
...
- Non-excludeability means that it is impossible or very costly to prevent someone that has not paid from consuming the goods
- Non-rivalry means the consumption of the goods by one person does not diminish the availability of the good for another person
- This implies that the consumption of the good by more people does not incur any additional costs (i.e. MCOP for providing for an additional user is zero)
- This does not mean it does not producing the goods has a total cost of 0
...
- Since public goods by nature are non-excludable, it is impossible or impractical for producers to exclude those who have not paid from consuming the goods
- Consumers can be free riders that benefit from a good or service without paying for it, therefore no consumer would be willing to pay for public goods
...
- Caused by
	1. Lack of skills and knowledge acquired form training and education  - e.g. becoming a doctor requires lengthy training to pick up required specialised knowledge and skills
	2. Lack of natural talent - e.g. not everyone can become a chef because the job requires a sharp palette, among other natural qualities
...
- Caused by
	...
	2. Costs of moving can be high - cost of buying and selling a house, removal expenses and other associated expenditure
	3. Differences in cost of living in different regions - e.g. cost of living is higher in cities than in rural areas, making workers unwilling and/ or unable to move and work in cities
...
- They will as a result increase their demand for the services of nurses/ social workers
...
- The healthcare industry is not able to get the desired amount of labour needed to increase quantity supplied to meet the rise in demand
